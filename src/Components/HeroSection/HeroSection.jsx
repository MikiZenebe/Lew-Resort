  ...
  return (
    <div className="">
      ...
      >
        ...
        <SwiperSlide>
  <div
    className="w-full h-[700px] md:h-[800px] xl:h-[850px] 3xl:h-[950px] relative grid items-center justify-center text-white pb-[150px] lg:pb-16 xl:pb-0"
    data-aos="fade-down"
  >
    {/* Video background */}
    <video
      className="absolute top-0 left-0 w-full h-full object-cover"
      src="/images/home-1/Lewishorttrailer.mp4"
      autoPlay
      loop
      muted
      playsInline
    ...
    <div className="absolute top-0 left-0 w-full h-full bg-[#1e1e1ede]"></div>

    {/* Content */}
    <div className="font-Garamond 2xl:w-[720px] text-center relative z-10">
    ...
    {/* contact info */}
    <div className="w-[221px] h-[50px] border-white border hidden md:flex items-center justify-center absolute left-0 top-1/2 -rotate-90 z-10">
